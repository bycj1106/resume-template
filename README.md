...
Portfolio Crystal 是一款基于 Astro、TypeScript 和 Tailwind CSS 构建的高品质个人简历网站主题。采用现代蓝色主题配色方案，结合玻璃态效果（Glassmorphism）UI 设计和流畅的几何图案背景动画，为开发者提供专业且极具视觉冲击力的个人作品集展示方案。
...
- **蓝色主题配色**：精心调校的 blue/cyan 渐变配色方案，营造专业且富有科技感的视觉体验
